...
function install_minikube() {
    ...
    var kubeDownArgs = ['-L', `-o`, `minikube_${minikubeVersion}.deb`, `https://github.com/kubernetes/minikube/releases/download/v${minikubeVersion}/minikube_${minikubeVersion}-0_amd64.deb`];
...
function start_minikube() {
    ...
    `v${kubernetesVersion}`, '--insecure-registry=localhost:5000', '--extra-config=kubeadm.ignore-preflight-errors=SystemVerification']
